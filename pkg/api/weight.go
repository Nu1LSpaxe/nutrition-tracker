...
const (
	// 1: Very Low Intensity activity multiplier
	veryLowActivity = 1.2
	// 2: Light exercise activity multiplier - 3-4x per week
	lightActivity = 1.375
	// 3: Moderate exercise activity multiplier - 3-5x per week 30-60 mins/session
	moderateActivity = 1.55
	// 4: High exercise activity multiplier - (6-7x per week for 45-60 mins)
	highActivity = 1.725
	// 5: Very high exercise activity multiplier - for people who is an Athlete
	veryHighActivity = 1.0
)

// Contains the methods of the user services
